...
const blogPosts = [
{
    ...
    Figure 7:
    <Box sx={{m: 3}}>
    <Box component="img" src={require('../../images/blog/HEM_sankey_800.png')} height={300}></Box>
    ...
    <Box sx={{m: 3}}>
    <Box component="img" src={require('../../images/blog/Simulation_Protocol.png')} height={180}></Box>
    </Box>
